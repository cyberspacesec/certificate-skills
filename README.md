...
- [`evals/evals.json`](evals/evals.json) contains skill-creator-style skill-selection eval prompts.
...
- [`evals/evals.json`](evals/evals.json) 保存 skill-creator 风格的技能选择测试提示词。
