...
- Generated `.skill` archives and skill eval workspaces are ignored and must not be tracked as source files.
...
- 生成的 `.skill` archives 和 skill eval workspaces 会被忽略，不能作为源码跟踪。
